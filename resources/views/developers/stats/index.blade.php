...
@section('content')
    <div class="bg-base-1 flex-fill">
        <div class="container h-100 py-3 my-3">
            ...
            <h2 class="mb-0 d-inline-block">{{ __('Stats') }}</h2>
...
<pre class="m-0 text-light">{!! str_replace(':id', '<span class="text-success">{id}</span>', route('stats.show', ['id' => ':id'])) !!}</pre>
</div>
...
curl --location --request GET '{!! str_replace(':id', '<span class="text-success">{id}</span>', route('stats.show', ['id' => ':id'])) !!}' \
